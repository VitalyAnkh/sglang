...
class LayerwiseOffloadManager:
    ...
    def release_all(self) -> None:
        ...
        # Keep layer 0 resident to match `release_layer`, which never releases
        # layer 0. This avoids having to re-prefetch layer 0 between requests.
        layer_indices = [i for i in self._gpu_layers.keys() if i > 0]
