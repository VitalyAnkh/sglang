...
class PipelineConfig:
    ...
    def postprocess_cfg_noise_pred(
        ...
        *,
        ...
        Pipelines that need special CFG behavior (e.g., Qwen-Image "True CFG") can override
        this method to adjust `noise_pred` after classifier-free guidance is applied.
        """
