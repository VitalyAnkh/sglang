...
class PipelineConfig:
    ...
    def postprocess_cfg_noise_pred(
        ...
        *,
        ...
        """Optionally postprocess the CFG-combined prediction.

        This hook allows pipeline-specific CFG variants (e.g., True CFG) without
        hard-coding model logic into the generic denoising stage.
        """
